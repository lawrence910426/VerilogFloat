...
HD_PWD='C:/home/github/VerilogFloat/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FLOAT32_ADD.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FLOAT32_ADD.tcl -notrace
