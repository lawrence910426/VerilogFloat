...
HD_PWD='C:/home/github/VerilogFloat/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Timing_Test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Timing_Test.tcl
